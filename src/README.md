...
2. Make sure your project has the required dependencies: @mui/material, @mui/icons-material, @emotion/styled, @emotion/react, @mui/x-data-grid,l @mui/x-date-pickers dayjs, react-router.
